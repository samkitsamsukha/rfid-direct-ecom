	...
	return (
		<div>
			<section className="text-gray-600 body-font overflow-hidden">
              ...
              RFID-enabled smart door enhances security and convenience by using radio frequency identification to grant access. It allows for keyless entry, tracks access logs in real-time, and can be integrated with smart home systems for advanced control and monitoring.
							</p>
							...
							<div className="flex justify-between">
								...
								<button 
									onClick={() => {(addToCart('door', 1, 2000, 'RFID Enabled Secure Door', 'SM', 'brown'))}} 
